...
|                    Admin Home Page                    |                   Cliente Home Page                   |
| :---------------------------------------------------: | :---------------------------------------------------: |
| <img src="docs/images/screenshot_1.png" width="100%"> | <img src="docs/images/screenshot_2.png" width="100%"> |

|                    Agendar Serviço                    |                  Cadastro de Horário                  |
| :---------------------------------------------------: | :---------------------------------------------------: |
| <img src="docs/images/screenshot_3.png" width="100%"> | <img src="docs/images/screenshot_4.png" width="100%"> |

|                 Cadastro de Serviços                  |                  Visualizar Serviços                  |
| :---------------------------------------------------: | :---------------------------------------------------: |
| <img src="docs/images/screenshot_5.png" width="100%"> | <img src="docs/images/screenshot_6.png" width="100%"> |

|                      Login Page                       |
| :---------------------------------------------------: |
| <img src="docs/images/screenshot_8.png" width="100%"> |
